...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new SDataSignalAccess( top.Demo04_USint->fixTo_1->dout );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/book/workspace/spinal_demo/./simWorkspace/Demo04_USint/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/book/workspace/spinal_demo/./simWorkspace/Demo04_USint/") + name + ".dat").c_str());
      #endif
    }
